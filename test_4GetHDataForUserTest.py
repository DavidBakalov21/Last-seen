...
class TestGetData(unittest.TestCase):
    ...
    def test__GetDataForUser__04_10_2023_18_45__TrueNone(self):
        ...
        result= GetHDataForUser.GetDataForUser(csv, '04-10-2023 18:45', '8c417d9d-b13f-f070-bf07-1fd9c768126f')
    ...
    def test__GetDataForUser__04_10_2023_18_56__FalseNearest(self):
        csv = os.path.join(TestGetData.DIR, 'GetDataForUser.csv')
        result = GetHDataForUser.GetDataForUser(csv, '04-10-2023 18:56', '8c417d9d-b13f-f070-bf07-1fd9c768126f')
    ...
    def test__GetDataForUser__WrongId__FalseNone(self):
        csv = os.path.join(TestGetData.DIR, 'GetDataForUser.csv')
        result = GetHDataForUser.GetDataForUser(csv, '04-10-2023 18:56', '8c417d9d-b1ddd3f-f070-bf07-1fd9c768126f')
